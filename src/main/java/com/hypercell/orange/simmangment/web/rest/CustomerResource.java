package com.hypercell.orange.simmangment.web.rest;

import com.hypercell.orange.simmangment.domain.Customer;
import com.hypercell.orange.simmangment.repository.CustomerRepository;
import com.hypercell.orange.simmangment.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.hypercell.orange.simmangment.domain.Customer}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class CustomerResource {
    ...
    private static final String ENTITY_NAME = "simManagementToolCustomer";
