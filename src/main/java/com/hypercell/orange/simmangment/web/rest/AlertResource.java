...
import com.hypercell.orange.simmangment.repository.AlertRepository;
...
/**
 * REST controller for managing {@link com.hypercell.orange.simmangment.domain.Alert}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class AlertResource {
    ...
    private static final String ENTITY_NAME = "simManagementToolAlert";
