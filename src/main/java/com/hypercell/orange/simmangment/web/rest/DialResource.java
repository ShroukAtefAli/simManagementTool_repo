...
import com.hypercell.orange.simmangment.repository.DialRepository;
...
/**
 * REST controller for managing {@link com.hypercell.orange.simmangment.domain.Dial}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class DialResource {
    ...
    private static final String ENTITY_NAME = "simManagementToolDial";
