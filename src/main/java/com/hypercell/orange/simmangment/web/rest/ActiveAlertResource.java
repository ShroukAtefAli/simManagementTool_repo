...
import com.hypercell.orange.simmangment.repository.ActiveAlertRepository;
...
/**
 * REST controller for managing {@link com.hypercell.orange.simmangment.domain.ActiveAlert}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ActiveAlertResource {
    ...
    private static final String ENTITY_NAME = "simManagementToolActiveAlert";
